...
export default function GeneratedResumePreviewScreen({ navigation, route }) {
  ...
  if (step === 2) {
    if (
      ...
      Alert.alert("Missing details", "Please fill all basic details before continuing.");
      return;
    }
  ...
  if (step === 3) {
    if (
      ...
      Alert.alert("Missing details", "Please fill all fields before generating your resume.");
      return;
    }
 ...
 navigation.navigate("GeneratedResumePreview", {
  ...
  {step === 1 ? "Continue" : step === 2 ? "Next" : "Generate Resume"}
</Text>
                    </Pressable>
                </ScrollView>
            </View>
